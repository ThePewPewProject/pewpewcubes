...
public enum SettingDescription {
    ...
    WEAPON_COOLDOWN("lasertagWeaponCooldown", 4L, SettingDataType.LONG, "ticks", 0L, null),
    WEAPON_REACH("lasertagWeaponReach", 50L, SettingDataType.LONG, "distance", 0L, null),
    ...
    LASERTARGET_HIT_SCORE("lasertargetHitScore", 100L, SettingDataType.LONG, "score", null, null),
    PLAYER_HIT_SCORE("playerHitScore", 20L, SettingDataType.LONG, "score", null, null),
    START_TIME("startTime", 10L, SettingDataType.LONG, "duration", 0L, null),
    PLAYER_DEACTIVATE_TIME("playerDeactivationDuration", 5L, SettingDataType.LONG, "duration", 0L, null),
    LASERTARGET_DEACTIVATE_TIME("lasertargetDeactivatedDuration", 7L, SettingDataType.LONG, "duration", 0L, null),
    PLAY_TIME("gameDuration", 10L, SettingDataType.LONG, "duration", 1L, null),
    ...
    ORIGIN_SPAWN("originSpawn", true, SettingDataType.BOOL, "value", null, null),
    DEATH_PENALTY("deathPenalty", 500L, SettingDataType.LONG, "score", null, null);
