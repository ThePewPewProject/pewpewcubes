...
public class GameStats {
     ...
     */
    public final ArrayList<Tuple<Colors.Color, Integer>> teamScores = new ArrayList<>(6);

    /**
     * Map every player to his score ordered by score
     */
    public final ArrayList<Tuple<PlayerEntity, Integer>> playerScores = new ArrayList<>();

    /**
     * Map every team to the teams players and their scores ordered by scores inside the teams
     */
    public final HashMap<Colors.Color, List<Tuple<PlayerEntity, Integer>>> teamPlayerScores = new HashMap<>();
}
