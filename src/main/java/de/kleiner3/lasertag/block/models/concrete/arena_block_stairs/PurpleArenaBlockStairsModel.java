...
public class PurpleArenaBlockStairsModel extends EmissiveStairsModel {
    public PurpleArenaBlockStairsModel() {
        super(
                "block/arena_block_dark",
                "block/purple_arena_block_glow",
                "block/arena_block_half_dark",
                "block/purple_arena_block_half_glow",
                "block/arena_block_stair_side_dark",
                "block/purple_arena_block_stair_side_glow"
        );
    }
}
