...
public class ArenaBlockModel implements UnbakedModel, BakedModel, FabricBakedModel {
    private static final SpriteIdentifier textureSpriteId= new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, new Identifier(LasertagMod.ID, "block/arena_block"));
    private static final SpriteIdentifier glowTextureSpriteId = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, new Identifier(LasertagMod.ID, "block/arena_block_glow"));

    private static Sprite textureSprite;
    private static Sprite glowTextureSprite;
