...
public class PinkArenaBlockStairsModel extends EmissiveStairsModel {
    public PinkArenaBlockStairsModel() {
        super(
                "block/arena_block_dark",
                "block/pink_arena_block_glow",
                "block/arena_block_half_dark",
                "block/pink_arena_block_half_glow",
                "block/arena_block_stair_side_dark",
                "block/pink_arena_block_stair_side_glow"
        );
    }
}
