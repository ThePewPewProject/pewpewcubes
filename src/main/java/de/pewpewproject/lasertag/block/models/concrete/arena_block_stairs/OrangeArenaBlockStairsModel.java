...
public class OrangeArenaBlockStairsModel extends EmissiveStairsModel {
    public OrangeArenaBlockStairsModel() {
        super(
                "block/arena_block_dark",
                "block/orange_arena_block_glow",
                "block/arena_block_half_dark",
                "block/orange_arena_block_half_glow",
                "block/arena_block_stair_side_dark",
                "block/orange_arena_block_stair_side_glow"
        );
    }
}
