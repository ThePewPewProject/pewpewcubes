...
public class BlueArenaBlockStairsModel extends EmissiveStairsModel {
    public BlueArenaBlockStairsModel() {
        super(
                "block/arena_block_dark",
                "block/blue_arena_block_glow",
                "block/arena_block_half_dark",
                "block/blue_arena_block_half_glow",
                "block/arena_block_stair_side_dark",
                "block/blue_arena_block_stair_side_glow"
        );
    }
}
