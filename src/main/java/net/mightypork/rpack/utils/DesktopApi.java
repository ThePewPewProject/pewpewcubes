 ...
 *
 * source: https://stackoverflow.com/a/18004334/20247322
 *
 * @author MightyPork
 */
public class DesktopApi {
    ...
    private static boolean openSystemSpecific(String what) {
        ...
        // >>> Edit by Étienne Muser: Reordered, because Windows is the most likely OS and nobody is gaming on Linux or Mac
        if (os.isWindows()) {
