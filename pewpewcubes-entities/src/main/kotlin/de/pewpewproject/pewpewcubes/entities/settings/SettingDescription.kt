...
import de.pewpewproject.pewpewcubes.entities.settings.valuetypes.*
import java.util.*

/**
 * Object holding all information about a setting
 *
 * @author Étienne Muser
 */
enum class SettingDescription(
    val settingName: String,
    val defaultValue: Any,
    val dataType: SettingDataType,
    val settingValueName: String,
    val minValue: Any?,
    val maxValue: Any?,
    ...
    CTF_FLAG_HOLDING_PLAYER_VISIBILITY(
        "flagHoldingPlayerVisibility", CTFFlagHoldingPlayerVisibility.GLOW, SettingDataType.ofEnum(
            CTFFlagHoldingPlayerVisibility::class.java
        ), "visibility", null, null, false
    ),
    ...
    companion object {
         ...
         */
        fun byName(settingName: String): Optional<SettingDescription> {
            return Arrays.stream(entries.toTypedArray())
                .filter { sd: SettingDescription -> sd.name == settingName }
                .findFirst()
        }
    }
}